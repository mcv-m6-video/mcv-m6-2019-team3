run('~/Repo/m6/vlfeat/toolbox/vl_setup.m');
clear;

% Parameters
num_frames = 123;
frame_dir = '~/Repo/m6/mcv-m6-2019-team3/datasets/cat_stab/cat_in/';
out_dir = '~/Repo/m6/mcv-m6-2019-team3/datasets/cat_stab/cat_matlab/';
...
% Save frames
for k=1:num_frames
    file_name = fullfile(out_dir, sprintf('img%04d.png', k));
